<!-- Nav Item - Dashboard -->
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo site_url('kepala/data_pegawai_c')?>">Pegawai Aktif</a>
 ...
 <hr class="sidebar-divider">
      ...
      <li class="nav-item">
        ...
        <div id="collapseSide" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Pilihan:</h6>
            ...
            <a class="collapse-item active" href="<?php echo site_url('kepala/acc_jabatan')?>">Kenaikan Jabatan</a>
