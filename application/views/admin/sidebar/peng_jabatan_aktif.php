      ...
      <li class="nav-item active">
        ...
        <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo site_url('admin/data_pengajuan_c/riwayat_pensiun')?>">Pensiun</a>
            <a class="collapse-item  active" href="<?php echo site_url('admin/data_pengajuan_c/riwayat_jabatan')?>">Kenaikan Jabatan</a>
