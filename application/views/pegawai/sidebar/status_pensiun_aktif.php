      ...
      <li class="nav-item active">
        ...
        <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          ...
          <a class="collapse-item" href="<?php echo site_url('pegawai/status_cuti_c/cek_cuti')?>">Cuti</a>
            <a class="collapse-item" href="<?php echo site_url('pegawai/status_jabatan_c/cek_jabatan')?>">Jabatan</a>
            <a class="collapse-item active" href="<?php echo site_url('pegawai/status_pensiun_c/cek_pensiun')?>">Pensiun</a>
          </div>
        </div>
      </li>
